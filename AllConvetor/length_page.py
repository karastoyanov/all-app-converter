...
class LengthMenu(QWidget):
    def __init__(self):
        ...
        self.setWindowIcon(QIcon(r'AllConvetor\images\ruler.png'))
        self.show()
    ...
    def convert(self):
            from lenght_convertor import calculate
            self.right_side_text.setText(str(calculate(self.l, self.r, 1)))
            self.right_side_text.show()  
